...
export default function AppBar() {
  ...
  return (
    <header className="fixed top-0 right-0 left-0 z-50 flex h-14 items-center gap-3 bg-zinc-900 px-4 text-zinc-100 shadow-md">
      ...
      <h1 className="text-lg font-bold tracking-wide">Metal Weather</h1>
    </header>
  );
}
